...
const UserHome = () => {
    ...
    return (
        <section className='h-full bg-[#F6F6F6] px-5 lg:px-10 mb-12'>
            <h1 className='text-2xl lg:text-left text-center uppercase font-bold font-family text-secondary pt-10'>Hi, Welcome Back!</h1>
